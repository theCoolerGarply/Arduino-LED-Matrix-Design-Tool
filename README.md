...
3. To create design an image, open the excel file and edit the text in the grey shaded section of the spread sheet. W for white, R for red, G for green, and B for blue.
   ![Image Example](Read Me Pictures/Image Example.png)
4. Copy the text in this cell ![Pattern Cell](Read Me Pictures/Pattern Cell.png) and paste it into the PATTERN constant in the script file ![Pattern Constant](Read Me Pictures/Pattern Constant.png).
